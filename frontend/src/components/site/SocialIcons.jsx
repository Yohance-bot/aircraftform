// Brand/social glyphs (lucide-react 1.x dropped brand icons, so we inline them).
...
export function FacebookIcon({ className = "h-5 w-5" }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M14 9V7.5c0-.7.3-1 1.1-1H16V4h-2c-2 0-3 1.2-3 3v2H9v2.5h2V20h3v-8.5h2.1l.4-2.5H14z" />
    </svg>
  );
}
